...
public class Finder extends Thread {
	...
	public void findAll() {
        ...
        while (matcher.find(start)) {
            ...
            if (_replace != null) {
                if (!replaceAll) {
                    ReplaceOptionsDialog dlg = new ReplaceOptionsDialog(HTMLLocal.getString("Replace this occurence?"));
                ...
                if (!showCdlg) {
                    ...
                    editor.toolsPanel.addTab(HTMLLocal.getString("Find"), cdlg);
                    showCdlg = true;
                }                
                this.suspend();
        ...
        JOptionPane.showMessageDialog(null, HTMLLocal.getString("Search complete")+".");
        if (showCdlg) {
            editor.toolsPanel.remove(cdlg);
            if (editor.toolsPanel.getTabCount() == 0)
                editor.hideToolsPanel();
