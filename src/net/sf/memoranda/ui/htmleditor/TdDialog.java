...
public class TdDialog extends JDialog {
  ...
  JComboBox<?> tdAlignCB = new JComboBox<Object>(aligns);
  ...
  JComboBox<?> tdValignCB = new JComboBox<Object>(tdvaligns);
  ...
  JComboBox<?> trAlignCB = new JComboBox<Object>(aligns);
  JComboBox<?> trValignCB = new JComboBox<Object>(tdvaligns);
  ...
  public TdDialog(Frame frame) {
    super(frame, HTMLLocal.getString("Table properties"), true);
    try {
      jbInit();
      pack();
    }
  ...
  void jbInit() throws Exception {
    ...
    header.setText(HTMLLocal.getString("Table properties"));
    ...
    jLabel4.setText(HTMLLocal.getString("Width"));
    ...
    jLabel7.setText(HTMLLocal.getString("Row span"));
    ...
    jLabel6.setText(HTMLLocal.getString("Col span"));
    ...
    jLabel9.setText(HTMLLocal.getString("Vert. align"));
    ...
    jLabel5.setText(HTMLLocal.getString("Height"));
    trPanel.setLayout(gridLayout4);
    trPanel.setBorder(border2);
    gridLayout4.setColumns(1);
    gridLayout4.setRows(2);
    jLabel20.setText(HTMLLocal.getString("Align"));
    ...
    jLabel21.setText(HTMLLocal.getString("Fill color"));
    ...
    tdNowrapChB.setText(HTMLLocal.getString("No text wrapping"));
    ...
    jLabel22.setText(HTMLLocal.getString("Align"));
    flowLayout10.setAlignment(FlowLayout.LEFT);
    jLabel16.setText(HTMLLocal.getString("Vert. align"));
    ...
    jLabel23.setText(HTMLLocal.getString("Fill color"));
    ...
    jLabel8.setText(HTMLLocal.getString("Width"));
    ...
    jLabel12.setText(HTMLLocal.getString("Border"));
    ...
    jLabel24.setText(HTMLLocal.getString("Align"));
    ...
    jLabel13.setText(HTMLLocal.getString("Cell spacing"));
    ...
    jLabel17.setText(HTMLLocal.getString("Vert. align"));
    ...
    jLabel25.setText(HTMLLocal.getString("Fill color"));
    ...
    jLabel14.setText(HTMLLocal.getString("Cell padding"));
    ...
    jLabel15.setText(HTMLLocal.getString("Height"));
    ...
    jTabbedPane1.add(tdPanel,  HTMLLocal.getString("Table cell"));
    jTabbedPane1.add(trPanel,  HTMLLocal.getString("Table row"));
    ...
    jTabbedPane1.add(tablePanel,  HTMLLocal.getString("Table"));
  }
  ...
  void tdBgcolorB_actionPerformed(ActionEvent e) {
     Color c = JColorChooser.showDialog(this, HTMLLocal.getString("Table cell background color"), Util.decodeColor(tdBgcolorField.getText()));
     if (c == null) return;
  ...
  void trBgcolorB_actionPerformed(ActionEvent e) {
     Color c = JColorChooser.showDialog(this, HTMLLocal.getString("Table row background color"), Util.decodeColor(trBgcolorField.getText()));
     if (c == null) return;
  ...
  void bgColorB_actionPerformed(ActionEvent e) {
    Color c = JColorChooser.showDialog(this, HTMLLocal.getString("Table background color"), Util.decodeColor(bgcolorField.getText()));
     if (c == null) return;
